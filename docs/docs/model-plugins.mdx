...
```tsx
import OpenAIChatPlugin from "@puzzlet/agentmark/models/openai-chat";
...
You can find a fully up-to-date list of built-in model plugins/providers here: [Built-in](https://github.com/puzzlet-ai/agentmark/blob/main/src/model-plugins/all-latest.ts).
