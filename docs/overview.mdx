...
It is built on top of [TemplateDX](https://github.com/puzzlet-ai/templatedx), which extends Markdown's familiar syntax to support complex, structured content needs.
