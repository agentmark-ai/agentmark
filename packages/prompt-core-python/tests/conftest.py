...
def math_ast(fixtures_dir: Path) -> dict:
    ...
    with open(fixtures_dir / "math.prompt.mdx.json", encoding="utf-8") as f:
        return json.load(f)
...
def image_ast(fixtures_dir: Path) -> dict:
    ...
    with open(fixtures_dir / "image.prompt.mdx.json", encoding="utf-8") as f:
        return json.load(f)
...
def speech_ast(fixtures_dir: Path) -> dict:
    ...
    with open(fixtures_dir / "speech.prompt.mdx.json", encoding="utf-8") as f:
        return json.load(f)
...
def attachments_ast(fixtures_dir: Path) -> dict:
    ...
    with open(fixtures_dir / "attachments.prompt.mdx.json", encoding="utf-8") as f:
        return json.load(f)
...
def text_ast(fixtures_dir: Path) -> dict:
    ...
    with open(fixtures_dir / "text.prompt.mdx.json", encoding="utf-8") as f:
        return json.load(f)
