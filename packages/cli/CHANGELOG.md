...
- Document the `agentmark export traces` CLI feature that was previously missed for versioning. ([#562](https://github.com/agentmark-ai/agentmark/pull/562))
...
- Fix pydantic-ai-v0 webhook crash and eliminate __version__ drift across all Python packages. ([#562](https://github.com/agentmark-ai/agentmark/pull/562))
