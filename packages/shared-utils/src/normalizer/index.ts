...
import { ClaudeAgentTransformer } from './transformers/claude-agent';
...
// Register AgentMark transformer - uses fixed scope name 'agentmark' from OTEL hooks
registry.register('agentmark', new ClaudeAgentTransformer());
...
export * from './transformers/claude-agent';
